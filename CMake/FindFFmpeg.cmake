...
############################################################################
pkg_check_modules(_FFMPEG_X264 libx264)
pkg_check_modules(_FFMPEG_X265 libx265)
pkg_check_modules(_FFMPEG_VPX libvpx)
############################################################################
...
############################################################################
find_library(_FFMPEG_LIBX264
NAMES x264
PATHS ${_FFMPEG_X264_LIBRARY_DIRS} /usr/lib/x86_64-linux-gnu /usr/lib /usr/local/lib /opt/local/lib /sw/lib
)

find_library(_FFMPEG_LIBX265
NAMES x265
PATHS ${_FFMPEG_X265_LIBRARY_DIRS} /usr/lib/x86_64-linux-gnu /usr/lib /usr/local/lib /opt/local/lib /sw/lib
)

find_library(_FFMPEG_LIBVPX
NAMES vpx
PATHS ${_FFMPEG_VPX_LIBRARY_DIRS} /usr/lib/x86_64-linux-gnu /usr/lib /usr/local/lib /opt/local/lib /sw/lib
)
